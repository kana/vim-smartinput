...
describe 'panacea#clear_rules'
  ...
  it 'should clear all defined rules'
    ...
    call panacea#define_rule(b:uruleA)
    Expect Ref('s:available_nrules') ==# [b:nruleA]

    call panacea#define_rule(b:uruleB)
...
describe 'panacea#define_default_rules'
  before
    SaveContext
  end
  ...
  it 'should override existing rules if conflicted'
    ...
    call panacea#define_rule({'at': 'x\%#', 'char': '(', 'input': '---'})
    call panacea#define_rule({'at': '\%#', 'char': '(', 'input': '---'})
...
describe 'panacea#define_rule'
  ...
  it 'should not define two or more "same" rules'
    ...
    call panacea#define_rule(b:uruleBd)
  ...
  it 'should sort defined rules by "priority" and "at" in descending order (1)'
    ...
    call panacea#define_rule(b:uruleC1)
    call panacea#define_rule(b:uruleC2)
